...
describe('POST /todos', () => {
  ...
  it('should not create todo with unvalid body data', (done) => {
    request(app)
      .post('/todos')
      .set('x-auth', users[0].tokens[0].token)
      .send({})
...
``
  ...
  it('shouldnt remove a todo created by another user', (done) => {
...
describe('POST /users', () => {
  ...
  it('should not create the user if the email is in use', (done) => {
...
describe('POST /users/login', () => {
  ...
  it('should log in the user and return auth token', (done) => {
    request(app)
      .post('/users/login')
      .send({
        email: users[1].email,
